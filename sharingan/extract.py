...
class Extractor:
    ...
    @staticmethod
    def site_3dnews():
        T = yield from upload(url="http://forum.3dnews.ru/member.php?username={}")
        yield T
    ...
    @staticmethod
    def site_500px():
        T = yield from upload(url="https://500px.com/{}")
        yield T
    ...
    @staticmethod
    def AllTrails():
        T = yield from upload(url="https://www.alltrails.com/members/{}")
        yield T
    ...
    @staticmethod
    def Archive_org():
        T = yield from upload(url="https://archive.org/details/@{}")
        yield T
    ...
    @staticmethod
    def AskFM():
        T = yield from upload(url="https://ask.fm/{}")
        yield T
    ...
    @staticmethod
    def BitCoinForum():
        T = yield from upload(url="https://bitcoinforum.com/profile/{}")
        yield T
    ...
    @staticmethod
    def Career_habr():
        T = yield from upload(url="https://career.habr.com/{}")
        yield T
    ...
    @staticmethod
    def Cent():
        T = yield from upload(url="https://beta.cent.co/@{}")
        yield T
    ...
    @staticmethod
    def Chatujme_cz():
        T = yield from upload(url="https://profil.chatujme.cz/{}")
        yield T

    @staticmethod
    def Chess():
        T = yield from upload(url="https://www.chess.com/ru/member/{}")
        yield T
    ...
    @staticmethod
    def Contently():
        T = yield from upload(url="https://{}.contently.com/")
        yield T
    ...
    @staticmethod
    def Dribbble():
        T = yield from upload(url="https://dribbble.com/{}")
        yield T

    @staticmethod
    def Duolingo():
        T = yield from upload(url="https://www.duolingo.com/profile/{}")
        yield T

    @staticmethod
    def Ebay():
        T = yield from upload(url="https://www.ebay.com/usr/{}")
        yield T

    @staticmethod
    def Ello():
        T = yield from upload(url="https://ello.co/{}")
        yield T
    ...
    @staticmethod
    def Euw():
        T = yield from upload(url="https://euw.op.gg/summoner/userName={}")
        yield T
    ...
    @staticmethod
    def Football():
        T = yield from upload(url="https://www.rusfootball.info/user/{}/")
        yield T
    ...
    @staticmethod
    def Freelance_habr():
        T = yield from upload(url="https://freelance.habr.com/freelancers/{}")
        yield T
    ...
    @staticmethod
    def GitLab():
        T = yield from upload(url="https://gitlab.com/{}")
        yield T
    ...
    @staticmethod
    def Gumroad():
        T = yield from upload(url="https://www.gumroad.com/{}")
        yield T
    ...
    @staticmethod
    def HackerNews():
        T = yield from upload(url="https://news.ycombinator.com/user?id={}")
        yield T

    @staticmethod
    def HackerOne():
        T = yield from upload(url="https://hackerone.com/{}")
        yield T

    @staticmethod
    def HackerRank():
        T = yield from upload(url="https://hackerrank.com/{}")
        yield T

    @staticmethod
    def House_Mixes_com():
        T = yield from upload(url="https://www.house-mixes.com/profile/{}")
        yield T

    @staticmethod
    def Houzz():
        T = yield from upload(url="https://houzz.com/user/{}")
        yield T
    ...
    @staticmethod
    def Hubski():
        T = yield from upload(url="https://hubski.com/user/{}")
        yield T

    @staticmethod
    def IFTTT():
        T = yield from upload(url="https://www.ifttt.com/p/{}")
        yield T
    ...
    @staticmethod
    def Instructables():
        T = yield from upload(url="https://www.instructables.com/member/{}")
        yield T
    ...
    @staticmethod
    def Kali_community():
        T = yield from upload(url="https://forums.kali.org/member.php?username={}")
        yield T
    ...
    @staticmethod
    def Kik():
        T = yield from upload(url="https://ws2.kik.com/user/{}")
        yield T

    @staticmethod
    def Kongregate():
        T = yield from upload(url="https://www.kongregate.com/accounts/{}")
        yield T
    ...
    @staticmethod
    def Letterboxd():
        T = yield from upload(url="https://letterboxd.com/{}")
        yield T

    @staticmethod
    def Lichess():
        T = yield from upload(url="https://lichess.org/@/{}")
        yield T
    ...
    @staticmethod
    def LiveLeak():
        T = yield from upload(url="https://www.liveleak.com/c/{}")
        yield T
    ...
    @staticmethod
    def Lolchess():
        T = yield from upload(url="https://lolchess.gg/profile/na/{}")
        yield T
    ...
    def NameMC__Minecraft_net_skins_():
        T = yield from upload(url="https://namemc.com/profile/{}")
        yield T

    @staticmethod
    def NationStates_Nation():
        T = yield from upload(url="https://nationstates.net/nation={}")
        yield T

    @staticmethod
    def NationStates_Region():
        T = yield from upload(url="https://nationstates.net/region={}")
        yield T
    ...
    @staticmethod
    def OurDJTalk():
        T = yield from upload(url="https://ourdjtalk.com/members?username={}")
        yield T

    @staticmethod
    def PCGamer():
        T = yield from upload(url="https://forums.pcgamer.com/members/?username={}")
        yield T
    ...
    @staticmethod
    def PlayStore():
        T = yield from upload(url="https://play.google.com/store/apps/developer?id={}")
        yield T
    ...
    @staticmethod
    def ProductHunt():
        T = yield from upload(url="https://www.producthunt.com/@{}")
        yield T
    ...
    @staticmethod
    def Realmeye():
        T = yield from upload(url="https://www.realmeye.com/player/{}")
        yield T
    ...
    @staticmethod
    def Repl_it():
        T = yield from upload(url="https://repl.it/@{}")
        yield T
    ...
    @staticmethod
    def ReverbNation():
        T = yield from upload(url="https://www.reverbnation.com/{}")
        yield T

    @staticmethod
    def Roblox():
        T = yield from upload(url="https://www.roblox.com/user.aspx?username={}")
        yield T
    ...
    @staticmethod
    def Scribd():
        T = yield from upload(url="https://www.scribd.com/{}")
        yield T
    ...
    @staticmethod
    def Signal():
        T = yield from upload(url="https://community.signalusers.org/u/{}")
        yield T
    ...
    @staticmethod
    def Speedrun_com():
        T = yield from upload(url="https://speedrun.com/user/{}")
        yield T
    ...
    @staticmethod
    def Steam():
        T = yield from upload(url="https://steamcommunity.com/id/{}")
        yield T

    @staticmethod
    def SteamGroup():
        T = yield from upload(url="https://steamcommunity.com/groups/{}")
        yield T

    @staticmethod
    def Steamid():
        T = yield from upload(url="https://steamid.uk/profile/{}")
        yield T
    ...
    @staticmethod
    def Tinder():
        T = yield from upload(url="https://www.gotinder.com/@{}")
        yield T

    @staticmethod
    def TrackmaniaLadder():
        T = yield from upload(url="http://en.tm-ladder.com/{}_rech.php")
        yield T
    ...
    @staticmethod
    def TrashboxRU():
        T = yield from upload(url="https://trashbox.ru/users/{}")
        yield T

    @staticmethod
    def Trello():
        T = yield from upload(url="https://trello.com/{}")
        yield T

    @staticmethod
    def TripAdvisor():
        T = yield from upload(url="https://tripadvisor.com/members/{}")
        yield T
    ...
    @staticmethod
    def Twitter():
        T = yield from upload(url="https://www.twitter.com/{}")
        yield T

    @staticmethod
    def Typeracer():
        T = yield from upload(url="https://data.typeracer.com/pit/profile?user={}")
        yield T
    ...
    @staticmethod
    def Velomania():
        T = yield from upload(url="https://forum.velomania.ru/member.php?username={}")
        yield T
    ...
    @staticmethod
    def Virgool():
        T = yield from upload(url="https://virgool.io/@{}")
        yield T
    ...
    @staticmethod
    def Wattpad():
        T = yield from upload(url="https://www.wattpad.com/user/{}")
        yield T

    @staticmethod
    def We_Heart_It():
        T = yield from upload(url="https://weheartit.com/{}")
        yield T
    ...
    @staticmethod
    def Wikidot():
        T = yield from upload(url="http://www.wikidot.com/user:info/{}")
        yield T

    @staticmethod
    def Wikipedia():
        T = yield from upload(url="https://www.wikipedia.org/wiki/User:{}")
        yield T
    ...
    @staticmethod
    def YouNow():
        T = yield from upload(url="https://www.younow.com/{}/")
        yield T
    ...
    @staticmethod
    def YouTube():
        T = yield from upload(url="https://www.youtube.com/{}")
        yield T

    @staticmethod
    def Zhihu():
        T = yield from upload(url="https://www.zhihu.com/people/{}")
        yield T
    ...
    @staticmethod
    def allmylinks():
        T = yield from upload(url="https://allmylinks.com/{}")
        yield T
    ...
    @staticmethod
    def babyRU():
        T = yield from upload(url="https://www.baby.ru/u/{}/")
        yield T
    ...
    @staticmethod
    def forum_guns():
        T = yield from upload(url="https://forum.guns.ru/forummisc/blog/{}")
        yield T

    @staticmethod
    def forumhouseRU():
        T = yield from upload(url="https://www.forumhouse.ru/members/?username={}")
        yield T
    ...
    @staticmethod
    def hunting():
        T = yield from upload(url="https://www.hunting.ru/forum/members/?username={}")
        yield T
    ...
    @staticmethod
    def igromania():
        T = yield from upload(url="http://forum.igromania.ru/member.php?username={}")
        yield T

    @staticmethod
    def interpals():
        T = yield from upload(url="https://www.interpals.net/{}")
        yield T
    ...
    @staticmethod
    def jeuxvideo():
        T = yield from upload(url="http://www.jeuxvideo.com/profil/{}?mode=infos")
        yield T
    ...
    @staticmethod
    def metacritic():
        T = yield from upload(url="https://www.metacritic.com/user/{}")
        yield T
    ...
    @staticmethod
    def opennet():
        T = yield from upload(url="https://www.opennet.ru/~{}")
        yield T
    ...
    @staticmethod
    def phpRU():
        T = yield from upload(url="https://php.ru/forum/members/?username={}")
        yield T
    ...
    @staticmethod
    def soylentnews():
        T = yield from upload(url="https://soylentnews.org/~{}")
        yield T

    @staticmethod
    def sparkpeople():
        T = yield from upload(url="https://www.sparkpeople.com/mypage.asp?id={}")
        yield T
    ...
    @staticmethod
    def tracr_co():
        T = yield from upload(url="https://tracr.co/users/1/{}")
        yield T

    @staticmethod
    def travellerspoint():
        T = yield from upload(url="https://www.travellerspoint.com/users/{}")
        yield T
